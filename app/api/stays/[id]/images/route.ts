...
/**
 * POST /api/stays/:id/images
 * Upload images for a stay (create mode)
 * Proxies to external API: POST /stays/:id/images
 *
 * Security:
...
export async function POST(
  ...
  try {
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URI}/stays/${id}/images`,
      {
        method: "POST",
        headers: {
    ...
    console.error("BFF Image Upload Error:", error);
    return Response.json(
      {
        error: "Server error",
        message:
...
/**
 * PATCH /api/stays/:id/images
 * Update images for a stay (add, update descriptions, reorder, delete)
 * Proxies to external API: PATCH /stays/:id/images
 *
 * Security:
 * - Authentication required
 * - User must own the stay or be admin
...
export async function PATCH(
  ...
  try {
    ...
    console.error("BFF Image Update Error:", error);
    return Response.json(
      {
        error: "Server error",
        message:
