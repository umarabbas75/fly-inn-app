...
export default function BookingRequestConfirmationPage() {
  ...
  useEffect(() => {
    ...
    const storedData = sessionStorage.getItem("booking_request_confirmation");
    ...
    if (storedData) {
      try {
        ...
        // Clear after reading
        sessionStorage.removeItem("booking_request_confirmation");
      } catch (e) {
      ...
      <div className="max-w-2xl mx-auto px-4 py-12 sm:py-20">
        ...
        <div className="text-center mb-10">
          <div className="relative inline-block">
            <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full bg-blue-100 flex items-center justify-center mx-auto mb-6 animate-[scale-in_0.5s_ease-out]">
              <Clock className="h-12 w-12 sm:h-14 sm:w-14 text-blue-600" />
            </div>
          </div>
          ...
          <p className="text-lg text-gray-600">
            Your booking request has been sent to the host. You&apos;ll be
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden mb-8">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
            <div className="flex items-center justify-between">
              <span className="text-white/80 text-sm">Request Number</span>
            ...
            {bookingDetails.grand_total > 0 && (
              <div className="pt-4 border-t border-gray-100">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Payment has been authorized. Funds will be charged when the
                  host accepts your request.
                </p>
              </div>
            )}
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-blue-800">
                The host has been notified of your booking request. They&apos;ll
                review it and respond soon. You&apos;ll receive an email
                notification once they make a decision. If accepted, your payment
                will be processed and your booking will be confirmed.
              </p>
            </div>
          </div>
        </div>
